...
You should:
•⁠  ⁠response should be of 2-3 lines
...
def calculate_confidence_interval(probabilities, confidence_level=0.95):
    ...
    lower = max(0, mean_prob - margin_error) * 100
    upper = min(1, mean_prob + margin_error) * 100
    mean = mean_prob * 100

    return round(lower, 2), round(upper, 2), round(mean, 2)
